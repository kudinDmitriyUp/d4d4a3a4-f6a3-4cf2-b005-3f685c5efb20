...
export const metadata: Metadata = {
  ...
  description: "Leading VC firm in Milan investing in early-stage tech startups. Strategic capital, mentorship, and network for European founders.",
  keywords: "venture capital, Milan, tech investment, startup funding, Series A",
